...
- Wide project documentation views include a right-side `On this page` rail. It is generated by `site.js` from the same TOC data that powers the sidebar after the lazy document fragment has loaded.
